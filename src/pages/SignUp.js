      ...
      <div className="signup--layout">
        <div className="signup--top-section">
          ...
          <div className="signup--btns">
            <button className="signup--fb-btn signup--btn">
              <FacebookIcon className="signup--fb-icon" />
        ...
        <form className="signup--form">
          ...
          />
          <h6 className="signup--form-name-small">
          ...
          <div className="signup--date-container">
            <div className="signup--date-wrappers">
              <label for="day" className="signup--form-date-labels">
                Day
              </label>
              <input
                id="day"
                className="signup--form-day-input input-date"
                type="text"
                placeholder="DD"
              />
            </div>
            ...
            <div className="signup--date-wrappers">
              <label for="month" className="signup--form-date-labels">
                Month
              </label>
              <select
                id="month"
                className="signup--form-month-input input-date"
              >
                <option>Month</option>
            ...
            <div className="signup--date-wrappers">
              <label for="year" className="signup--form-date-labels">
                Year
              </label>
              <input
                id="year"
                className="signup--form-year-input input-date"
                type="text"
                placeholder="YYYY"
              />
            </div>
          ...
          <div className="signup--gender-wrapper">
            ...
            <input
              ...
              type="radio"
            />
            <label htmlFor="nonbinary" className="label-radio">
              Non-binary
            </label>
            <input
              name="signup-radio"
              ...
              type="radio"
            />
            <label htmlFor="other" className="label-radio">
              Other
            </label>
            <br />
            <input
              name="signup-radio"
              id="prefer"
              className="input-radio radio-prefer"
              type="radio"
            />
            <label htmlFor="prefer" className="label-radio">
              Prefer not to say
            </label>
          </div>
          ...
          <div className="signup--checkbox-container">
            ...
            <div className="signup--checkbox-wrapper">
              ...
              <label htmlFor="data-sharing" className="signup--checkbox-label">
                ...
                country outside of the EEA as <br /> described in our privacy
                policy.
              </label>
            </div>
          </div>
        ...
        <h5 className="signup--tc">
          Spotify is a personalised service. By clicking on sign-up, you agree
          to Spotify's&nbsp;
          <Link
